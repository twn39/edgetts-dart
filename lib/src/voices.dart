...
Future<List<Voice>> listVoices({http.Client? client, String? proxy}) async {
  ...
  try {
    ...
    final url = "${Constants.voiceList}&Sec-MS-GEC=$secMsGec&Sec-MS-GEC-Version=${Constants.secMsGecVersion}";
    ...
    if (response.statusCode == 200) {
        ...
        */
        ...
        if (response.statusCode == 403) {
            ...
            if (dateHeader != null) {
                ...
                if (serverDate != null) {
                    ...
                    final retryUrl = "${Constants.voiceList}&Sec-MS-GEC=$retrySecMsGec&Sec-MS-GEC-Version=${Constants.secMsGecVersion}";
                    final retryResponse = await httpClient.get(Uri.parse(retryUrl), headers: headers);
        ...
        throw Exception("Failed to list voices: ${response.statusCode} ${response.body}");
    }
  } finally {
    if (client == null) {
      httpClient.close();
